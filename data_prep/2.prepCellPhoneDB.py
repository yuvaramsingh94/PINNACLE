...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Preparing input files for CellPhoneDB."
    )
    parser.add_argument(
        "-data",
        type=str,
        default="/n/data1/hms/dbmi/zitnik/lab/datasets/2022-09-TabulaSapiens/data/TabulaSapiens.h5ad",
        help="Data as h5ad file.",
    )
    parser.add_argument(
        "-get_counts",
        type=bool,
        default=False,
        help="Convert sparse to dense matrix (memory intensive).",
    )
    parser.add_argument(
        "-subsample",
        type=bool,
        default=False,
        help="Randomly sample cells without replacement.",
    )
    parser.add_argument(
        "-percent", type=float, default=0, help="Percentage of cells to sample."
    )
    parser.add_argument(
        "-output_subsample_f", type=str, help="Filename for subsampled cells."
    )
    parser.add_argument(
        "-output_meta_f",
        type=str,
        default="/n/data1/hms/dbmi/zitnik/lab/datasets/2022-09-TabulaSapiens/processed/",
        help="Output prefix",
    )
